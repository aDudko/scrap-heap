...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getTranslationForDayOfWeek("Четверг"));
        System.out.println(getTranslationForDayOfWeek("Пятница"));
        System.out.println(getTranslationForDayOfWeek("Суббота"));
        System.out.println(getTranslationForDayOfWeek("Воскресенье"));
